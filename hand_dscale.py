...
print(f"🎵 Using MIDI device ID: {device_id}")

if device_id == -1:
    print("⚠️ No MIDI output device found! Try enabling a virtual MIDI driver (loopMIDI on Windows, IAC Driver on Mac).")
    exit()
...
def play_chord(chord_notes):
    print(f"🎹 Playing notes: {chord_notes}")  # Debugging
